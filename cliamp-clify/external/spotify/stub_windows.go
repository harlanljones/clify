...
func WithHistory(_ *history.Store) Option { return func(*SpotifyProvider) {} }
...
func New(_ *Session, _ string, _ int, _ ...Option) *SpotifyProvider { return nil }
...
// Login returns an error — Spotify auth is unavailable on Windows.
func Login(_ context.Context, _ string) error { return errSpotifyUnavailable }
